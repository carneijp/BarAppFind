...
struct InsertValuesBar {
    ...
    func loadBars(){
        ...
        var pedrinho: Bar = Bar(name: "Boteco Pedrini", description: "Nada melhor que vir se divertir com seus amigos ou familiares aqui no Pedrini! 😄", mood: ["Family friendly", "Barzinho"], grade: 5.0, latitude: -30.03736053756768, longitude: -51.222716864275185, operatinhours: ["monday: 16:00-03:00", "tuesday: 16:00-03:00", "wednesday: 16:00-04:00", "thrusday: 16:00-04:00", "friday: 16:00-05:00", "saturday: 16:00-05:00", "sunday: 16:00-03:00"], endereco: "R. Gen. Lima e Silva, 431 - Cidade Baixa, Porto Alegre", regiao: "Cidade Baixa", caracteristicas: ["Ao ar livre","Madrugada", "Climatizado", "Wifi", "Permitido fumar"])
